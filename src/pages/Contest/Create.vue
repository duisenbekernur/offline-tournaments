            ...
            >
                <div class="flex">
                    ...
                    <el-form-item class="form-item">
                        ...
                        <div class="ml-10">
                            <el-select
                                v-model="form.contestData.visibility"
                ...
                <div class="flex">
                    <div
                        class="w-2/3"
                        :class="{
                            'w-3/5 border-r-2 pr-8': form.contestData.visibility === 'private',
                        }"
                    ...
                    >
                        ...
                        <el-form-item class="form-item">
                            ...
                            <div class="w-full">
                                <el-select
                                    v-model="form.contestRequirement.participation"
                                    placeholder="участие"
                                >
                                    <el-option
                        ...
                        <el-form-item class="form-item">
                            ...
                            <div class="w-full">
                                <el-select
                                    v-model="form.contestRequirement.gender"
                                    placeholder="пол"
                                >
                                    <el-option
                        ...
                        <el-form-item class="form-item">
                            ...
                            <div class="w-full">
                                <el-select
                                    v-model="form.contestRequirement.minAge"
                                    placeholder="мин. возрасть"
                                >
                                    <el-option
                                        v-for="age in ageSelect"
                                        :value="age"
                                        :key="age"
                                        :label="age"
                                    />
                                ...
                                <el-select
                                    v-model="form.contestRequirement.maxAge"
                                    placeholder="макс. возрасть"
                                >
                                    <el-option
                                        v-for="age in ageSelect"
                                        :value="age"
                            ...
                            <div class="w-full">
                                ...
                                <div v-if="typeof form.contestLocation.address === 'string'">
                                    <el-tag class="ml-2" type="warning">{{
                                        form.contestLocation.country
                                    }}</el-tag>
                                    <el-tag class="ml-2" type="warning">{{
                                        form.contestLocation.city
                                    }}</el-tag>
                                    <el-tag class="ml-2" type="warning">{{
                                        form.contestLocation.address
                                    }}</el-tag>
                                </div>
                            </div>
                        </el-form-item>
                        ...
                        <el-form-item class="flex flex-col">
                            <div v-for="item in form.Expenses" class="flex gap-2 mb-2">
                                ...
                                <el-button
                                    v-if="item.id > 1"
                                    @click="
                                        form.Expenses = form.Expenses.filter(e => e.id !== item.id)
                                    "
                                    >-</el-button
                                >
                            </div>
                    ...
                    <div
                        v-if="
                            form.contestData.visibility === 'private' &&
                            form.contestData.categoryId === 1
                        "
                        class="ml-4 mt-2"
                    >
                        ...
                        <template v-if="form.team_count">
                            <el-form-item class="form-item" v-for="(team, i) in form.teams">
                                ...
                                <el-button
                                    class="ml-2"
                                    type="danger"
                                    @click="form.teams = form.teams.filter(t => t.pos !== team.pos)"
                                    >-</el-button
                                >
                        ...
                        <el-button
                            @click="
                                form.teams.push({
                                    pos: form.teams[form.teams.length - 1].pos + 1,
                                    name: '',
                                    users: [{ pos: 1, name: '', telegram: null }],
                                });
                                form.team_count++;
                            "
                            type="primary"
    ...
    methods: {
        ...
        async onSubmit() {
            ...
            this.form.contestData.startDate = new Date(
                `${this.formatDateDash(
                    new Date(this.temp.day)
                )} ${this.temp.time.toLocaleTimeString()}`
            );
