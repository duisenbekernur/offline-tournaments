<template>
  <div v-loading="loadingData" class="w-full">
    <div class="relative">
      ...
      />
      <img v-else class="absolute -bottom-10 left-0 right-0 mx-auto rounded-full w-[200px] object-cover w-[200px] text-white" src="../../assets/sad.svg" />
    </div>
    ...
    <div v-if="user">
      <el-tabs v-model="activeTabName" type="border-card" class="mt-10">
        <el-tab-pane :label="item.label" :name="item.name" v-for="item in tabs"></el-tab-pane>
    ...
    return {
      ...
      tabs: [
        ...
        },
        {
          ...
          label: "Приглашенные пользователями",
        },
      ],
    };
  },
